...
final class ShellTest extends TestCase
{
    ...
    {
        $result = \RunnerDeck\Shell::exec([PHP_BINARY, '-r', 'echo "hello"; exit(0);'], 5);
    ...
    {
        $result = \RunnerDeck\Shell::exec([PHP_BINARY, '-r', 'exit(3);'], 5);
    ...
    {
        $result = \RunnerDeck\Shell::exec([PHP_BINARY, '-r', 'sleep(5);'], 1);
